  ...
  return (
    <div className="lg:container">
      ...
      >
        ...
        <div className="xl:w-[30%] sm:w-[50%] w-[30%] self-center mt-20 flex items-center justify-between h-fit py-2 px-4 bg-[rgba(37,37,51,0.93)] border-solid border-2 border-[#a09f9f] rounded-md ">
